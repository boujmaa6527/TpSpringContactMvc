...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(AuthenticationManagerBuilder authBuilder) throws Exception{
        ...
        authBuilder.inMemoryAuthentication().withUser("rachid").password(passWord.encode("12345")).roles("ADMIN", "USER");
        authBuilder.inMemoryAuthentication().withUser("jean").password(passWord.encode("12345")).roles("USER");
